...
import featuredGroceries from '../featuredGroceries.json';
...
// Import images
import cat01 from '../assets/images/category/01.webp';
import cat02 from '../assets/images/category/02.webp';
import cat03 from '../assets/images/category/03.webp';
import cat04 from '../assets/images/category/04.webp';
import cat05 from '../assets/images/category/05.webp';
import cat06 from '../assets/images/category/06.webp';
import cat07 from '../assets/images/category/07.webp';
import cat08 from '../assets/images/category/08.webp';
import cat09 from '../assets/images/category/09.webp';
import cat10 from '../assets/images/category/10.webp';



const Home = () => {
  // Put imported images in array
  const images = [cat01, cat02, cat03, cat04, cat05, cat06, cat07, cat08, cat09, cat10];
                      ...
                      <div className="banner-bg-image bg_image bg_one-banner ptb--120 ptb_md--80 ptb_sm--60">
                        <div className="banner-one-inner-content">
                          ...
                          <a href="/shop" className="rts-btn btn-primary radious-sm with-icon">
                            ...
                            <div className="arrow-icon"><i className="fa fa-arrow-right"></i></div>
                            <div className="arrow-icon"><i className="fa fa-arrow-right"></i></div>
                          </a>
                        </div>
                      </div>
                  ...
                  >
                    {images.map((imgSrc, index) => (
                      <SwiperSlide key={index}>
                        <a className="single-category-one" href="/shop-grid-sidebar">
                          <img
            ...
            <div className="col-lg-12">
              <div className="category-area-main-wrapper-one">
                <Swiper
                  ...
                  autoplay={{ delay: 2000, disableOnInteraction: false }}
                  spaceBetween={30}
                  slidesPerView={6} // Change as per requirement
                  loop={true}
                >
                  {featuredGroceries.map((item) => (
                    <SwiperSlide key={item.id} className="single-shopping-card-one">
                      <div className="image-and-action-area-wrapper">
                        <a href={item.link} className="thumbnail-preview">
                          <div className="badge">
                            <span>{item.badge.split(" ")[0]}% <br />Off</span>
                      ...
                      <div className="body-content">
                        ...
                        <div className="cart-counter-action">
                          ...
                          <a href="#" className="rts-btn btn-primary add-to-card radious-sm with-icon">
            ...
            <div className="col-lg-12">
              <div className="title-area-between">
                ...
                <div className="countdown">
                  <div className="countDown">
                    <div className="container"><div className="a"><div>104</div></div></div>
                    <div className="container"><div className="a"><div>06</div></div></div>
                    <div className="container"><div className="a"><div>35</div></div></div>
                    <div className="container"><div className="a"><div>56</div></div></div>
                  </div>
                </div>
              </div>
            </div>
                    ...
                    <div className="row g-4">
                      ...
                      <div className="col-lg-6">
                        <div className="single-shopping-card-one discount-offer">
                          <a href="/shop/details-profitable-business-makes-your-profit" className="thumbnail-preview">
                            <div className="badge">
                              <span>25% <br />Off</span>
                              <i className="fa-solid fa-bookmark"></i>
                            </div>
                          ...
                          <div className="body-content">
                            <a href="/shop/details-profitable-business-makes-your-profit">
                              <h4 className="title">Details Profitable business makes your profit</h4>
                            </a>
                      ...
                      {/* Repeat other product cards here with similar structure */}
                      {/* Example with Firebase business */}
                      <div className="col-lg-6">
                        <div className="single-shopping-card-one discount-offer">
                          <a href="/shop/firebase-business-makes-your-profit" className="thumbnail-preview">
                            <div className="badge">
                              <span>25% <br />Off</span>
                              <i className="fa-solid fa-bookmark"></i>
                            </div>
                          ...
                          <div className="body-content">
                            <a href="/shop/firebase-business-makes-your-profit">
                              <h4 className="title">Firebase business makes your profit</h4>
                            </a>
                            <span className="availability">500g Pack</span>
                            <div className="price-area">
                              <span className="current">$50.00</span>
                              <div className="previous">$36.00</div>
                            </div>
                            <div className="cart-counter-action">
                              <div className="quantity-edit">
                      ...
                      <div className="col-lg-6">
                        <div className="single-shopping-card-one discount-offer">
                          ...
                          <div className="body-content">
                            <a href="/shop/firebase-business-makes-your-profit">
                              <h4 className="title">Netlyfy business makes your profit</h4>
                            </a>
                            <span className="availability">500g Pack</span>
                            <div className="price-area">
                              <span className="current">$19.00</span>
                              <div className="previous">$36.00</div>
                            </div>
                            <div className="cart-counter-action">
                              <div className="quantity-edit">
                      ...
                      <div className="col-lg-6">
                        <div className="single-shopping-card-one discount-offer">
                          ...
                          <div className="body-content">
                            <a href="/shop/firebase-business-makes-your-profit">
                              <h4 className="title">Details business makes your profit</h4>
                            </a>
                            <span className="availability">500g Pack</span>
                            <div className="price-area">
                              <span className="current">$90.00</span>
                              <div className="previous">$36.00</div>
                            </div>
                            <div className="cart-counter-action">
                              <div className="quantity-edit">
                ...
                <div className="row g-4">
                  ...
                  <div className="col-xl-3 col-md-6 col-sm-12 col-12">
                    <div className="single-shopping-card-one tranding-product">
                      ...
                      <div className="body-content">
                        <a href="/shop"><h4 className="title">Pastine Mellin Filid</h4></a>
                        <span className="availability">500g Pack</span>
                        <div className="price-area">
                  ...
                  <div className="col-xl-3 col-md-6 col-sm-12 col-12">
                    <div className="single-shopping-card-one tranding-product">
                      ...
                      <div className="body-content">
                        <a href="/shop"><h4 className="title">Di Grano Tenero</h4></a>
                        <span className="availability">500g Pack</span>
                        <div className="price-area">
                          <span className="current">$36.00</span>
                          <div className="previous">$36.00</div>
                  ...
                  <div className="col-xl-3 col-md-6 col-sm-12 col-12">
                    <div className="single-shopping-card-one tranding-product">
                      ...
                      <div className="body-content">
                        <a href="/shop"><h4 className="title">Mellin Grano Tenero</h4></a>
                        <span className="availability">500g Pack</span>
                        <div className="price-area">
                          <span className="current">$36.00</span>
                          <div className="previous">$36.00</div>
                  ...
                  <div className="col-xl-3 col-md-6 col-sm-12 col-12">
                    <div className="single-shopping-card-one tranding-product">
                      ...
                      <div className="body-content">
                        <a href="/shop"><h4 className="title">Grano Tenero</h4></a>
                        <span className="availability">500g Pack</span>
                        <div className="price-area">
                          <span className="current">$36.00</span>
                          <div className="previous">$36.00</div>
                  ...
                  <div className="col-xl-3 col-md-6 col-sm-12 col-12">
                    <div className="single-shopping-card-one tranding-product">
                      ...
                      <div className="body-content">
                        <a href="/shop"><h4 className="title">Jack Froot</h4></a>
                        <span className="availability">500g Pack</span>
                        <div className="price-area">
                          <span className="current">$36.00</span>
                          <div className="previous">$36.00</div>
                  ...
                  <div className="col-xl-3 col-md-6 col-sm-12 col-12">
                    <div className="single-shopping-card-one tranding-product">
                      ...
                      <div className="body-content">
                        <a href="/shop"><h4 className="title">Fresh Mango</h4></a>
                        <span className="availability">500g Pack</span>
                        <div className="price-area">
                          <span className="current">$36.00</span>
                          <div className="previous">$36.00</div>
                  ...
                  <div className="col-xl-3 col-md-6 col-sm-12 col-12">
                    <div className="single-shopping-card-one tranding-product">
                      ...
                      <div className="body-content">
                        <a href="/shop"><h4 className="title">Fresh Juice</h4></a>
                        <span className="availability">500g Pack</span>
                        <div className="price-area">
                          <span className="current">$36.00</span>
                          <div className="previous">$36.00</div>
                  ...
                  <div className="col-xl-3 col-md-6 col-sm-12 col-12">
                    <div className="single-shopping-card-one tranding-product">
                      ...
                      <div className="body-content">
                        <a href="/shop"><h4 className="title">Pastine Mellin</h4></a>
                        <span className="availability">500g Pack</span>
                        <div className="price-area">
                          <span className="current">$36.00</span>
                          <div className="previous">$36.00</div>
                    ...
                    <div key={blog.id} className="col-lg-3 col-md-6 col-sm-12">
                      <div className="single-blog-area-start">
                        ...
                        <div className="blog-body">
                          ...
                          <a href={blog.link} className="shop-now-goshop-btn">
